    ...
    <footer className="relative border-t border-white/10 mt-20">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-space font-bold bg-gradient-to-r from-primary to-purple-500 bg-clip-text text-transparent">
                AURA
              </span>
            </div>
            ...
            <p className="text-sm text-gray-500 font-inter leading-relaxed">
              Revolutionizing emergency response in smart cities through artificial intelligence and real-time monitoring.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-space font-semibold text-white mb-4">Quick Links</h4>
          ...
          {/* Developer Info */}
          <div>
            <h4 className="text-lg font-space font-semibold text-white mb-4">Developer</h4>
            <div className="space-y-3">
              <p className="text-gray-400 font-inter">
                <span className="text-white font-semibold">Ankit Kumbhare</span>
              </p>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-lg font-space font-semibold text-white mb-4">Resources</h4>
            <ul className="space-y-3">
              <li>
                <a 
                  href="https://github.com/Ankitcodes30/AURA.git"
        ...
        <div className="border-t border-white/10 pt-8">
          ...
          <p className="text-center text-gray-600 font-inter text-xs mt-4">
            Built for smarter, safer cities. Powered by AI.
          </p>
        </div>
      </div>
    </footer>
